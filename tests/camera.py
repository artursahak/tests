...
def show_webcam(mirror=False):
    ...
    while True:
        ...
        cv2.rectangle(img, (10, 90), (80, 150), (97,95,255) , -1)
        cv2.rectangle(img, (10, 150), (80, 210), (253,255,160) , -1)
        if mousedown:
            cv2.rectangle(img,
...
# Blue color in BGR 
            ...
            traverse_point.append(int(outputBoxToDraw[3]))
...
# Using cv2.putText() method 
            ...
            cv2.rectangle(img, (10, 90), (80, 150), color_dict["right"], -1)
            cv2.rectangle(img, (10, 150), (80, 210), color_dict["bottom"], -1)
            cv2.putText(img,'Line width:',(5,230),font,0.4,(255,255,255),thickness,cv2.LINE_AA)
